  ...
  return (
    ...
    >
      <div className="w-[1081px] flex flex-row items-end justify-between max-w-full gap-5 mq1050:flex-wrap">
        <div className="w-[425px] flex flex-col items-start justify-start gap-[115px] min-w-[425px] max-w-full mq450:gap-[57px] mq750:min-w-full mq1050:flex-1">
        ...
        <div className="w-[373px] flex flex-col items-start justify-end pt-0 px-0 pb-px box-border min-w-[373px] max-w-full mq450:min-w-full mq1050:flex-1">
          <div className="self-stretch flex flex-col items-start justify-start gap-[120px] max-w-full mq450:gap-[60px]">
