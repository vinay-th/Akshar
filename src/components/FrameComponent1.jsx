...
const FrameComponent1 = ({ className = "" }) => {
  return (
    ...
    >
      ...
      />
      <div className="flex-1 rounded-t-none rounded-br-281xl rounded-bl-none bg-bg flex flex-col items-start justify-start pt-[33px] px-[120px] pb-[141px] box-border gap-[90px] max-w-full mq450:gap-[22px] mq450:pl-5 mq450:pr-5 mq450:box-border mq750:gap-[45px] mq750:pt-[21px] mq750:px-[60px] mq750:pb-[92px] mq750:box-border">
          ...
          <div className="w-[574px] flex flex-row items-end justify-start gap-6 max-w-full mq750:hidden">
            <nav className="m-0 flex-1 flex flex-col items-start justify-end pt-0 px-0 pb-[11px]">
              <nav className="m-0 self-stretch h-[19px] relative text-left text-lg text-darkslategray-200 font-title">
                <a className="[text-decoration:none] absolute top-[0px] left-[0px] leading-[23px] text-[inherit] inline-block w-[52px] h-[19px] min-w-[52px] z-[1]">
                  Home
                </a>
                <a className="[text-decoration:none] absolute top-[0px] left-[72px] leading-[23px] text-[inherit] inline-block w-[54px] h-[19px] min-w-[54px] whitespace-nowrap z-[1]">{`About `}</a>
                <a className="[text-decoration:none] absolute top-[0px] left-[146px] leading-[23px] text-[inherit] inline-block w-[52px] h-[19px] z-[1]">
                  FAQs
                </a>
                <a className="[text-decoration:none] absolute top-[0px] left-[218px] leading-[23px] text-[inherit] inline-block w-[66px] h-[19px] min-w-[66px] whitespace-nowrap z-[1]">{`Contact `}</a>
              </nav>
            </nav>
            <button className="cursor-pointer border-black border-[1px] border-solid py-[7px] pl-[22px] pr-[21px] bg-white overflow-hidden flex flex-row items-start justify-start z-[1] hover:bg-gainsboro hover:border-darkslategray-100 hover:border-[1px] hover:border-solid hover:box-border">
            ...
            <button className="cursor-pointer [border:none] py-[8.5px] px-[25px] bg-black overflow-hidden flex flex-row items-start justify-start z-[1] hover:bg-darkslategray-100">
        ...
        <div className="w-[713px] flex flex-row items-start justify-start py-0 px-[5px] box-border max-w-full">
          <div className="flex-1 flex flex-col items-start justify-start gap-5 max-w-full">
            <h1 className="m-0 self-stretch relative text-inherit font-black font-inherit z-[1] mq450:text-19xl mq1050:text-32xl">
              Learn, Connect, Grow.
            </h1>
